...
def loads(components_dir: str = "components") -> List[Tuple[Dict[str, Any], Type]]:
    """
    Scans for component kits supporting v3.1 loader.
    This version is based on v3 but adds support for 'INJECT_METHODS'
    to allow tools to inject methods into the main canvas system.
    ...
    logger.info(f"KitLoader v3.1: Loading assets for theme: {theme}")
